...
freddie_mercury = User.create!(name: "Freddie Mercury", email: "freddiee@mercury.com", password: "123456", password_confirmation: "123456")
...
diana_ross = User.create(name: "Diana Ross", email: "dianaa@ross.com", password: "123456", password_confirmation: "123456")
...
michael_jackson = User.create(name: "Michael Jackson", email: "michaell@jackson.com", password: "123456", password_confirmation: "123456")
michael_jackson.favorites.create(favoritable: trinity)
michael_jackson.favorites.create(favoritable: paw_paw_tree)
 
celine_dion = User.create(name: "Celine Dion", email: "celinee@dion.com", password: "123456", password_confirmation: "123456")
